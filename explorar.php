...
<section id="tab-explore" class="tab-content px-4 max-w-7xl mx-auto w-full py-6">
    ...
    <script>window.LIBROS = <?= json_encode($libros) ?>;</script>
    <script>
        ...
        function aplicarFiltros() {
            ...
            grid.innerHTML = libros.length === 0
                ? `<p class="col-span-full text-center text-[#a8a5a0] py-10">No se encontraron libros.</p>`
                : libros.map(libro => `
                    <div class="book-card group cursor-pointer" onclick='verLibro(${JSON.stringify(libro)})'>
        ...
        // Cargar resultados iniciales (todos los libros)
        aplicarFiltros();
    </script>
</section>
