...
-- Sirve para clasificar los libros (ficción, fantasía, etc.)
CREATE TABLE generos (
  id INT AUTO_INCREMENT PRIMARY KEY, -- Identificador único del género
  nombre VARCHAR(100)                -- Nombre del género
);

-- Insertamos los géneros disponibles en la aplicación
...
CREATE TABLE usuarios (
  ...
  usuario VARCHAR(50),               -- Nombre o nickname del usuario
...
-- Tabla de tiendas donde se pueden comprar los libros
CREATE TABLE tienda (
  id INT AUTO_INCREMENT PRIMARY KEY, -- ID único de la tienda
  nombre VARCHAR(50),                -- Nombre de la tienda (Amazon, Fnac, etc.)
  icono VARCHAR(100),                -- Ruta del icono de la tienda
  estrellas DOUBLE,                  -- Valoración de la tienda (ej: 4.5)
  envio VARCHAR(50)                  -- Información sobre el envío
);
...
-- =====================================================
-- 2. TABLAS QUE DEPENDEN DE GENEROS
-- =====================================================
...
CREATE TABLE libros (
  ...
  genero_id INT,                     -- Relación con la tabla generos
  valoracion DECIMAL(2,1),           -- Valoración media del libro (ej: 4.5)
  lecturas INT,                      -- Número de veces leído / popularidad
  anio INT,                          -- Año de publicación
  paginas INT,                       -- Número de páginas
  portada VARCHAR(100),              -- Ruta de la imagen de portada
  descripcion TEXT,                  -- Descripción del libro
  
  -- Clave foránea: cada libro pertenece a un género
...
-- =====================================================
-- 3. TABLA CLAVE DEL COMPARADOR (PRECIOS)
-- =====================================================

-- Relaciona libros con tiendas (muchos a muchos)
-- Un libro puede estar en muchas tiendas
-- Una tienda vende muchos libros
CREATE TABLE precios (
  id INT AUTO_INCREMENT PRIMARY KEY, -- ID del registro
  libro_id INT,                      -- Libro al que pertenece el precio
  tienda_id INT,                     -- Tienda donde se vende
  precio DECIMAL(6,2),               -- Precio del libro
  url TEXT,                          -- Enlace directo al producto
...
(9,3,7.99,'https://www.fnac.es/a383780/Antoine-de-Saint-Exupery-El-Principito'),
(9,4,5.00,'https://www.iberlibro.com/Principito-Saint-Exup%C3%A9ry-Antoine-Salamandra/32357411280/bd'),
(9,5,9.50,'https://www.elcorteingles.es/libros/A1824916-el-principito-tapa-dura/?stype=text_box&color=Sin+especificar'),
(10,1,19.90,'https://www.amazon.es/Quijote-Mancha-Ilustrado-Gustave-Dore/dp/8441442967/ref=sr_1_5?__mk_es_ES=%C3%85M%C3%85%C5%BD%C3%95%C3%91&crid=3QO2YJT1GNQSS&dib=eyJ2IjoiMSJ9.C4b-lnjfz3X3gpLv88vU40rrq2TnfRMevb6qFGq7oTjvhvBIBj-Lxl8mNgkIXE7k9yKm_YHt9j1Md4R-a7kW'),
(10,2,14.95,'https://www.casadellibro.com/libro-don-quijote-de-la-mancha/9788467953930/2640316'),
(10,3,14.95,'https://www.fnac.es/a1272651/Miguel-de-Cervantes-Don-Quijote-de-la-Mancha'),
(10,4,9.99,'https://www.iberlibro.com/Don-Quijote-Mancha-Miguel-Cervantes-Espasa/32301752462/bd'),
(10,5,19.95,'https://www.elcorteingles.es/libros/A25665879-don-quijote-de-la-mancha-tapa-dura/?stype=text_box&color=Sin+especificar'),
(11,1,16.50,'https://www.amazon.es/Steve-Jobs-Walter-Isaacson/dp/8499921477/ref=sr_1_1'),
(11,2,16.50,'https://www.casadellibro.com/libro-steve-jobs/9788499921471/2032847'),
(11,3,16.50,'https://www.fnac.es/a611580/Walter-Isaacson-Steve-Jobs'),
(11,4,10.00,'https://www.iberlibro.com/Steve-Jobs-Walter-Isaacson-Debate/32200000001/bd'),
(11,5,18.95,'https://www.elcorteingles.es/libros/A8889000-steve-jobs-tapa-blanda/?stype=text_box&color=Sin+especificar'),
(12,1,18.90,'https://www.amazon.es/Los-pilares-la-Tierra/dp/8401352789/ref=sr_1_1'),
(12,2,18.90,'https://www.casadellibro.com/libro-los-pilares-de-la-tierra/9788401352782/2040000'),
(12,3,18.90,'https://www.fnac.es/a400000/Ken-Follett-Los-pilares-de-la-tierra'),
(12,4,12.00,'https://www.iberlibro.com/pilares-tierra-Ken-Follett-Plaza/32300000001/bd'),
(12,5,19.95,'https://www.elcorteingles.es/libros/A9000000-los-pilares-de-la-tierra/?stype=text_box&color=Sin+especificar'),
(13,1,14.20,'https://www.amazon.es/Dune-Frank-Herbert/dp/8466353771/ref=sr_1_1'),
...
-- Tabla de reseñas de usuarios sobre libros
CREATE TABLE resenias (
  id INT AUTO_INCREMENT PRIMARY KEY, -- ID de la reseña
  libro_id INT,                      -- Libro reseñado
  usuario_id INT,                    -- Usuario que hace la reseña
  valoracion INT,                    -- Puntuación (ej: 1-5)
  texto TEXT,                        -- Comentario
  fecha DATETIME DEFAULT CURRENT_TIMESTAMP, -- Fecha automática
...
-- Tabla que guarda la relación personal usuario-libro
-- (tipo "mi biblioteca")
CREATE TABLE usuario_libros (
  id INT AUTO_INCREMENT PRIMARY KEY, -- ID del registro
  usuario_id INT,                    -- Usuario
  libro_id INT,                      -- Libro
  estado ENUM('pendiente','leyendo','terminado'), -- Estado de lectura del libro
  valoracion DECIMAL(2,1),           -- Valoración personal del usuario
  resenia TEXT,                      -- Opinión personal (puede duplicar info de reseñas)
