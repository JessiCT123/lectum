...
<div class="grid gap-6">
  ...
  <?php 
    $masLeidos = $libros;
    usort($masLeidos, function($a, $b) { return $b['lecturas'] <=> $a['lecturas']; });
  ...
  <?php 
    ...
    usort($mejorValorados, function($a, $b) { return $b['valoracion'] <=> $a['valoracion']; });
        ...
        <div class="relative text-center">
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-wrap justify-center gap-2">
                    <button onclick="actualizarEstadoLibro(${libro.id}, 'leyendo')" class="flex-1 bg-[#2a9d8f]/20 hover:bg-[#2a9d8f] text-[#2a9d8f] hover:text-white border border-[#2a9d8f]/30 px-2 py-2 rounded-lg text-[10px] font-bold transition-all">
                        LEYENDO
                    </button>
                    <button onclick="actualizarEstadoLibro(${libro.id}, 'pendiente')" class="flex-1 bg-gray-500/20 hover:bg-gray-500 text-gray-400 hover:text-white border border-gray-500/30 px-2 py-2 rounded-lg text-[10px] font-bold transition-all">
                        PENDIENTE
                    </button>
                    <button onclick="actualizarEstadoLibro(${libro.id}, 'completado')" class="flex-1 bg-[#f4a261]/20 hover:bg-[#f4a261] text-[#f4a261] hover:text-[#0f0f1a] border border-[#f4a261]/30 px-2 py-2 rounded-lg text-[10px] font-bold transition-all">
                        TERMINADO
                    </button>
                </div>
            </div>

            <a href="compararPrecios.php?id=${libro.id}" class="flex items-center justify-center gap-2 w-full bg-[#16213e] hover:bg-[#f4a261] text-[#f4a261] hover:text-[#0f0f1a] py-3 rounded-xl border border-[#f4a261]/50 font-bold text-xs transition-all uppercase tracking-widest">
